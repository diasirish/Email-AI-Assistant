...
def main():
    ...
    # MLflow setup
    if args.use_mlflow:
        mlflow.set_experiment("Email Classification Experiment")
        mlflow.start_run(run_name="DistilBERT")
    ...
    for epoch in range(EPOCHS):
        ...
        # Save model and log to MLflow if performance improves
        if f1 > best_f1:
            best_f1 = f1
            ...
            if args.use_mlflow:
                ...
                # Alternatively, log the model using mlflow.pytorch
    ...
    if args.use_mlflow:
        # Log metrics file as an artifact
